...
//  const machine = new ChiChiNES.NESMachine(cpu, whizzler, new ChiChiNES.TileDoodler(whizzler), wavsharer, soundbop, new ChiChiNES.Sound.SoundThreader(null));
//  const machine.PadOne = this.controlPad;
//  const tileDoodler = new Tiler(this.machine);
//  const machine.Cpu.Debugging = false; 
