...
var ChiChiMemoryMap_1 = __webpack_require__(4);
...
var BaseCart = /** @class */ (function () {
    ...
    function BaseCart(romFile) {
        ...
        this.ramMask = 0x1fff;
        this.cartState = new ArrayBuffer(0);
...
var MemoryMap = /** @class */ (function () {
    ...
    Object.defineProperty(MemoryMap.prototype, "irqRaised", {
        get: function () {
    ...
    MemoryMap.prototype.advanceScanline = function (value) {
        while (value-- >= 0) {
            this.cart.updateScanlineCounter();
        }
    };
    MemoryMap.prototype.setupStateBuffer = function (sb) {
        var _this = this;
        sb.onRestore.subscribe(function (buffer) {
            _this.Rams = buffer.getUint8Array('rams');
        });
...
var romLoader = /** @class */ (function () {
    ...
    romLoader.prototype.loadRom = function (data, name) {
        var cart = ChiChiCarts_1.iNESFileHandler.loadBuffer(data);
        return cart;
    };
    return romLoader;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
var BaseCart_1 = __webpack_require__(0);
var Discrete = __webpack_require__(8);
var CNROMCart_1 = __webpack_require__(9);
var Multi = __webpack_require__(10);
var MMC1 = __webpack_require__(11);
var MMC2 = __webpack_require__(12);
var MMC3 = __webpack_require__(13);
var M068 = __webpack_require__(14);
var Nsf = __webpack_require__(15);
var Smb2j = __webpack_require__(16);
var VS = __webpack_require__(17);
var VRC = __webpack_require__(19);
var VRC2 = __webpack_require__(5);
var VRC6 = __webpack_require__(20);
var Sunsoft = __webpack_require__(21);
var Mapper034 = __webpack_require__(22);
var Mapper015 = __webpack_require__(23);
var Mapper112 = __webpack_require__(24);
var Mapper132 = __webpack_require__(25);
var Mapper133 = __webpack_require__(26);
var Mapper193 = __webpack_require__(27);
var Mapper228 = __webpack_require__(28);
var NESFileDecoder_1 = __webpack_require__(29);
var MapperFactory = /** @class */ (function () {
    function MapperFactory() {
        ...
        this[15] = Mapper015.Mapper015Cart;
        ...
        this[99] = VS.VSCart;
        this[112] = Mapper112.Mapper112Cart;
        this[132] = Mapper132.Mapper132Cart;
        this[133] = Mapper133.Mapper133Cart;
    ...
    MapperFactory.prototype.createCart = function (file) {
        var cart;
        var mapper = file.mapperId;
        if (this[mapper]) {
            cart = new this[mapper](file);
        }
        else {
            cart = new BaseCart_1.UnsupportedCart(file);
        }
        // cart.loadFile(file);
        return cart;
    };
...
var iNESFileHandler = /** @class */ (function () {
    ...
    iNESFileHandler.loadBuffer = function (buffer) {
        return new MapperFactory().createCart(new NESFileDecoder_1.NESFileDecoder(buffer));
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var BaseCart_1 = __webpack_require__(0);
var VSMemoryMap_1 = __webpack_require__(18);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ChiChiMemoryMap_1 = __webpack_require__(4);
var VSMemoryMap = /** @class */ (function (_super) {
    __extends(VSMemoryMap, _super);
    function VSMemoryMap(cpu, cart) {
        var _this = _super.call(this, cpu, cart) || this;
        _this.cpu = cpu;
        _this.cart = cart;
        return _this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var KonamiVRC2_1 = __webpack_require__(5);
...
var NESFileDecoder = /** @class */ (function () {
    function NESFileDecoder(buffer) {
        if (buffer === void 0) { buffer = new ArrayBuffer(16); }
        this._buffer = buffer;
    ...
    Object.defineProperty(NESFileDecoder.prototype, "romCRC", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "mapperId", {
        get: function () {
            var maps = this.mapperBytes;
            var id = (maps[0] & 240);
            id = id >> 4;
            id = id | (maps[1] & 0xf0);
            id |= (maps[2] & 0xF) << 8;
    ...
    Object.defineProperty(NESFileDecoder.prototype, "submapperId", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "prgRomCount", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "prgRomLength", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "chrRomCount", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "chrRomLength", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "prgRamBanks", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "prgRamBanksBatteryBacked", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "chrRamBanks", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "chrRamBanksBatteryBacked", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "isPC10", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "isVS", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "usesSRAM", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "batterySRAM", {
        get: function () {
            return (this.mapperBytes[0] & 2) === 2;
        },
        enumerable: true,
    ...
    Object.defineProperty(NESFileDecoder.prototype, "mirroring", {
        get: function () {
    ...
    Object.defineProperty(NESFileDecoder.prototype, "fourScreen", {
        get: function () {
    ...
    return NESFileDecoder;
}());
exports.NESFileDecoder = NESFileDecoder;
...
module.exports = {
  crc1: __webpack_require__(35),
  crc8: __webpack_require__(36),
  crc81wire: __webpack_require__(37),
  crc16: __webpack_require__(38),
  crc16ccitt: __webpack_require__(39),
  crc16modbus: __webpack_require__(40),
  crc16xmodem: __webpack_require__(41),
  crc16kermit: __webpack_require__(42),
  crc24: __webpack_require__(43),
  crc32: __webpack_require__(44),
  crcjam: __webpack_require__(45)
};
