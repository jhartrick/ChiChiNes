...
define("chichi/ChiChiCarts", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("chichi/ChiChiTypes", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    // utility classes
    var RunningStatuses;
...
define("chichi/ChiChiAudio", ["require", "exports", "chichi/ChiChiTypes"], function (require, exports, ChiChiTypes_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("chichi/ChiChiControl", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //input classes
...
define("chichi/ChiChi.HWCore", ["require", "exports", "chichi/ChiChiCarts", "chichi/ChiChiAudio", "chichi/ChiChiTypes", "chichi/ChiChiControl"], function (require, exports, ChiChiCarts_1, ChiChiAudio_1, ChiChiTypes_2, ChiChiControl_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var iNESFileHandler = /** @class */ (function () {
        function iNESFileHandler() {
        }
        iNESFileHandler.LoadROM = function (ppu, thefile) {
            var _cart = null;
        ...
        iNESFileHandler.LoadNSF = function (ppu, thefile) {
            var _cart = null;
            ...
            */
            ...
            if (_cart != null) {
                ...
                ppu.ChrRomHandler = _cart;
                _cart.ROMHashFunction = null; //Hashers.HashFunction;
                _cart.LoadNSFFile(iNesHeader, 1, 0, theRom, chrRom, chrOffset);
            }
            return _cart;
        };
    ...
    var ChiChiMachine = /** @class */ (function () {
        ...
        ChiChiMachine.prototype.Reset = function () {
            if (this.Cpu != null && this.Cart != null) {
                ...
                //ClearGenieCodes();
                this.Cpu.PowerOn();
                this.RunState = ChiChiTypes_2.RunningStatuses.Running;
            }
        };
        ...
        ChiChiMachine.prototype.PowerOff = function () {
            this.RunState = ChiChiTypes_2.RunningStatuses.Off;
        };
        ...
        ChiChiMachine.prototype.LoadNSF = function (rom) {
            ...
            debugger;
            this.EjectCart();
            var cart = iNESFileHandler.LoadNSF(this.Cpu, rom);
            if (cart == null) {
                ...
                this.Cpu.Cart.NMIHandler = function () { _this.Cpu.InterruptRequest(); };
    ...
    var ChiChiCPPU = /** @class */ (function () {
        function ChiChiCPPU(bopper) {
            ...
            // Current Instruction
            this._currentInstruction_AddressingMode = ChiChiTypes_2.ChiChiCPPU_AddressingModes.Bullshit;
        ...
        ChiChiCPPU.prototype.Step = function () {
            ...
            switch (this._currentInstruction_AddressingMode) {
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.Absolute:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.AbsoluteX:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.AbsoluteY:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.Indirect:
                    ...
                    break;
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.ZeroPage:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.ZeroPageX:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.ZeroPageY:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.Relative:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.IndexedIndirect:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.IndirectIndexed:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.IndirectZeroPage:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.Immediate:
                    this._currentInstruction_Parameters0 = this.GetByte(this._programCounter++);
                    break;
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.Accumulator:
                case ChiChiTypes_2.ChiChiCPPU_AddressingModes.Implicit:
                    break;
                default:
        ...
        ChiChiCPPU.prototype.Execute = function () {
            ...
            switch (this._currentInstruction_OpCode) {
                ...
                case 30:
                    ...
                    data = (data << 1) & 254;
                    if (this._currentInstruction_AddressingMode === ChiChiTypes_2.ChiChiCPPU_AddressingModes.Accumulator) {
                ...
                case 108:
                    ...
                    if (this._currentInstruction_AddressingMode === ChiChiTypes_2.ChiChiCPPU_AddressingModes.Indirect && this._currentInstruction_Parameters0 === 255) {
                ...
                case 137:
                    ...
                    //case 0xfc:
                    //NOP();
                    if (this._currentInstruction_AddressingMode === ChiChiTypes_2.ChiChiCPPU_AddressingModes.AbsoluteX) {
                        this.DecodeAddress();
                    }
                    break;
                case 9:
        ...
        ChiChiCPPU.prototype.WriteInstructionHistoryAndUsage = function () {
            var inst = new ChiChiTypes_2.ChiChiInstruction();
        ...
        ChiChiCPPU.prototype.PPU_InitSprites = function () {
            ...
            for (var i = 0; i < this._maxSpritesPerScanline; ++i) {
                this.currentSprites[i] = new ChiChiTypes_2.ChiChiSprite();
            }
            this.unpackedSprites = new Array(64);
            for (var i = 0; i < 64; ++i) {
                this.unpackedSprites[i] = new ChiChiTypes_2.ChiChiSprite();
            }
        };
