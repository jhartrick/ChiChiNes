...
export declare class iNESFileHandler implements ChiChiNES.ROMLoader.iNESFileHandler {
...
export declare class ChiChiMachine {
    ...
    FrameCount: number;
    IsRunning: boolean;
    readonly PadOne: ChiChiNES.IControlPad;
    readonly PadTwo: ChiChiNES.IControlPad;
