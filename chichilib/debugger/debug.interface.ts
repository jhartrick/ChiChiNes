...
export class Debugger {
    ...
    private _cpu: ChiChiCPPU;
    get cpu(): ChiChiCPPU { return this._cpu };
    set cpu(value: ChiChiCPPU) {
        this._cpu = value;
        this._cpu.addDebugEvent(() => {
            
            //this.updateState();
        });
    }
    lastInstructions: Array<DecodedInstruction> = new Array <DecodedInstruction>();
    constructor() {
    }
    ...
    private setInstructionPage(inst: DecodedInstruction[], start: number, frameNumber?: number): void {
    ...
    public disassemble(inst: DecodedInstruction): string {
