...
namespace ChiChiNES
{
    public partial class CPU2A03
    {
        ...
        public void PPU_SetByte(int Clock, int address, int data)
        {
            // DrawTo(Clock);
            //if (_isDebugging)
            //{
        ...
        public int PPU_GetByte(int Clock, int address)
        {
            //if (_isDebugging)
            //{
        ...
        //public MachineEvent PPU_NMIHandler
        //{
        //    get
        //    {
        //        return nmiHandler;
        ...
        public void PPU_HandleEvent(int Clock)
        {
            DrawTo(Clock);
        }

        public void PPU_ResetClock(int Clock)
        {
            lastcpuClock = Clock;
        }
        ...
        public MachineEvent PPU_FrameFinishHandler
        {
