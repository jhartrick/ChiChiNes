...
{
    public class DebuggerCPUState
    {
        private int _accumulator;

        public DebuggerCPUState()
        {
            setupticks();
        }
        ...
        private int _indexRegisterX, _indexRegisterY;
        ...
        private int _programCounter, _statusRegister;
        ...
        private NES.CPU.Fastendo.CPU2A03.Instruction[] instructionHistory;

        public NES.CPU.Fastendo.CPU2A03.Instruction[] InstructionHistory
        {
            set { instructionHistory = value; }
            get { return instructionHistory; }
        }

        private int[] instructionUsage = new int[0x100];

        public int[] InstructionUsage
        {
            get { return instructionUsage; }
            set { instructionUsage = value; }
        }


        private int instructionHistoryPointer;

        public int InstructionHistoryPointer
        {
            get { return instructionHistoryPointer; }
            set { instructionHistoryPointer = value; }
        }
        ...
        private NES.CPU.Fastendo.CPU2A03.Instruction _currentInstruction;

        public NES.CPU.Fastendo.CPU2A03.Instruction CurrentInstruction
        {
        ...
        {
            get { return CurrentInstruction.OpCode; }
        }

        public string LastInstruction
        {
            get { return CurrentInstruction.Disassemble(); }
        }
        ...
        public void setupticks()
        {
            ...
            addressmode[0x2] = AddressingModes.Bullshit;
            clockcount[0x3] = 2;
            ...
            addressmode[0xb] = AddressingModes.Bullshit;
            clockcount[0xc] = 4;
